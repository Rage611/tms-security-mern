...
//     { id: 5, city: "Greater Noida", top: "34%", left: "38%", vDir: "up", hDir: "right", tier: "tier-2", desc: "Logistics Hub & Rapid Response Center." },
...
const SiteMarker = ({ top, left, vDir, hDir, title, sites, index, tier }) => {
  const baseDelay = index * 0.2;
...
const Network = () => {
  ...
  const beacons = [
    { id: 1, city: "Delhi", top: "28%", left: "31%", vDir: "down", hDir: "left", tier: "tier-1", sites: ["Corporate Headquarters", "Connaught Place Hub"] },
    { id: 2, city: "Haryana", top: "27%", left: "28%", vDir: "up", hDir: "left", tier: "tier-2", sites: ["Manesar Industrial Zone", "Panipat Refinery"] },
    { id: 6, city: "Chandigarh", top: "21%", left: "30%", vDir: "up", hDir: "left", tier: "tier-1", sites: ["Sector 17 Command", "Mohali IT Park"] },
    { id: 4, city: "Noida", top: "30%", left: "35%", vDir: "up", hDir: "right", tier: "tier-1", sites: ["Sector 62 IT Hub", "Film City Complex"] },
    { id: 5, city: "Greater Noida", top: "34%", left: "38%", vDir: "up", hDir: "right", tier: "tier-2", sites: ["Knowledge Park Escorts", "Yamuna Expressway Patrol"] },
    { id: 3, city: "Patna", top: "38%", left: "60%", vDir: "down", hDir: "right", tier: "tier-1", sites: ["Gandhi Maidan Zone", "Patliputra Industrial"] },
  ];
