...
const PSO = () => {
  return (
    <div className="service-page full-width">
      <Helmet>
        <title>Personal Security Officer (PSO) Services | TMS Security</title>
        <meta name="description" content="TMS Security provides elite close protection specialists for C-Suite executives, VIPs and high-net-worth individuals across India." />
        <link rel="canonical" href="https://tmssecurity.in/pso" />
      </Helmet>
