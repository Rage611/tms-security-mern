  ...
  return (
    <div className="service-page full-width" key={pathname}>
      ...
      <Helmet>
        ...
        <meta name="description" content="TMS Security provides highly trained security guards for corporate, industrial and residential deployments across Delhi NCR. Ex-servicemen and verified personnel." />
        <link rel="canonical" href="https://tmssecurity.in/security-guards" />
      </Helmet>
